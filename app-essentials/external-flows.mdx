...
External Flows empower you to seamlessly use an existing automation as a block within a flow. The two components of building these nested automations are <Link href="/blocks/core/input">input blocks</Link> and <Link href="/blocks/core/output">output blocks</Link>.
