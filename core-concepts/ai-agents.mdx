---
title: AI Agents
description: Blocks that act as a mini employee
---
...
<Warning>AI Agents are experimental</Warning>

<Frame>
  <img
    className="block dark:hidden"
    src="/images/core-concepts/ai-agent-light.png"
    alt="AI Agent Block"
  />
  <img
    className="hidden dark:block"
    src="/images/core-concepts/ai-agent-dark.png"
    alt="AI Agent Block"
  />
</Frame>
